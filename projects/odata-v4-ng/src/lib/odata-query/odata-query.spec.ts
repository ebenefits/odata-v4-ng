import { HttpHeaders, provideHttpClient, withInterceptorsFromDi, withXhr } from '@angular/common/http';
...
describe('OdataQuery', () => {
    ...
    it('should create entitySet request using binary filter', () => {
        ...
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People?$filter=' + encodeURIComponent('FirstName eq \'Scott\''));
    });
    ...
    it('should create entitySet request using contains filter', () => {
        ...
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People?$filter=' + encodeURIComponent('contains(Location/Address,\'San Francisco\')'));
    });
    ...
    it('should create entitySet request using binary filter with enum', () => {
        ...
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People?$filter=' + encodeURIComponent('Gender eq Microsoft.OData.SampleService.Models.TripPin.PersonGender\'Female\''));
    });
    ...
    it('should create expand request', () => {
        ...
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People(\'russellwhyte\')?$expand=Trips');
    });
    ...
    it('should create expand request using select', () => {
        ...
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People(\'russellwhyte\')?$expand=Trips($select=Name)');
    });
    ...
    it('should create expand request using filter', () => {
        ...
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People(\'russellwhyte\')?$expand=Trips($filter=' + encodeURIComponent('Name eq \'Trip in US\')'));
    });
    ...
    it('should create orderby request', () => {
        ...
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People?$orderby=EndsAt desc');
    });
    ...
    it('should create skip and top request', () => {
        const odataQuery: ODataQuery = new ODataQuery(odataService, SERVICE_ROOT)
            .entitySet(ENTITY_SET)
            .skip(10).top(20);
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People?$skip=10&$top=20');
    });
    ...
    it('should create count request', () => {
        const odataQuery: ODataQuery = new ODataQuery(odataService, SERVICE_ROOT)
            .entitySet(ENTITY_SET)
            .countSegment();
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People/$count');
    });
    ...
    it('should create count=true request', () => {
        const odataQuery: ODataQuery = new ODataQuery(odataService, SERVICE_ROOT)
            .entitySet(ENTITY_SET)
            .countOption(true);
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People?$count=true');
    });
    ...
    it('should create select request', () => {
        ...
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People?$select=Name,IcaoCode');
    });
    ...
    it('should create search request', () => {
        ...
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People?$search=' + encodeURIComponent('Boise'));
    });
    ...
    it('should create lambda any on properties request', () => {
        ...
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People?$filter=' + encodeURIComponent('Emails/any(x:endswith(x,\'contoso.com\'))'));
    });
    ...
    it('should create lambda all on properties request', () => {
        ...
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People?$filter=' + encodeURIComponent('Emails/all(x:endswith(x,\'contoso.com\'))'));
    });
    ...
    it('should create lambda any on properties request', () => {
        ...
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People?$filter=' + encodeURIComponent('Friends/any(x:x/FirstName eq \'Scott\')'));
    });
    ...
    it('should create lambda all on properties request', () => {
        ...
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People?$filter=' + encodeURIComponent('Friends/all(x:x/FirstName eq \'Scott\')'));
    });
    ...
    it('should create unbound function call request', () => {
        ...
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/GetNearestAirport(lat = 33, lon = -118)');
    });
    ...
    it('should create bound function call request', () => {
        ...
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People(\'russellwhyte\')/Microsoft.OData.SampleService.Models.TripPin.GetFavoriteAirline()');
    });

    it('should create unbound action call request', () => {
        const odataQuery: ODataQuery = new ODataQuery(odataService, SERVICE_ROOT)
            .actionCall('Microsoft.OData.SampleService.Models.TripPin.ShareTrip');
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/Microsoft.OData.SampleService.Models.TripPin.ShareTrip');
    });
    ...
    it('should create bound action call request', () => {
        const odataQuery: ODataQuery = new ODataQuery(odataService, SERVICE_ROOT)
            ...
            .entityKey(new QuotedString('russellwhyte'))
            .actionCall('Microsoft.OData.SampleService.Models.TripPin.ShareTrip');
        expect(odataQuery.toString()).toEqual(SERVICE_ROOT + '/People(\'russellwhyte\')/Microsoft.OData.SampleService.Models.TripPin.ShareTrip');
    });

    it('test get', () => {
        const odataQuery: ODataQuery = new ODataQuery(odataService, SERVICE_ROOT);
        vi.spyOn(odataQuery, 'get').mockReturnValue(undefined);
        vi.spyOn(odataQuery, 'post').mockReturnValue(undefined);
        vi.spyOn(odataQuery, 'patch').mockReturnValue(undefined);
        vi.spyOn(odataQuery, 'put').mockReturnValue(undefined);
        vi.spyOn(odataQuery, 'delete').mockReturnValue(undefined);
    ...
    it('test toEntitySet', async () => {
        ...
        new ODataQuery(odataService, SERVICE_ROOT).entitySet(ENTITY_SET).get().subscribe((odataResponse: ODataResponse) => {
    ...
    it('test toComplexCollection', async () => {
        const httpMock: HttpTestingController = TestBed.inject(HttpTestingController);
        const responseBody: any = { value: [{ type: 'type1' }, { type: 'type2' }] };
        const responseHeaders: any = { headers: { 'Content-Type': 'application/json' } };
    ...
    it('test toEntity', async () => {
        const httpMock: HttpTestingController = TestBed.inject(HttpTestingController);
        const responseBody: any = { type: 'type1' };
        const responseHeaders: any = { headers: { 'Content-Type': 'application/json' } };

        new ODataQuery(odataService, SERVICE_ROOT).entitySet(ENTITY_SET).entityKey('entityKey').get().subscribe((odataResponse: ODataResponse) => {
    ...
    it('test toPropertyValue', async () => {
        const httpMock: HttpTestingController = TestBed.inject(HttpTestingController);
        const responseBody: any = { value: 'type1' };
        const responseHeaders: any = { headers: { 'Content-Type': 'application/json' } };

        new ODataQuery(odataService, SERVICE_ROOT).entitySet(ENTITY_SET).entityKey('entityKey').property('property').get().subscribe((odataResponse: ODataResponse) => {
    ...
    it('test toCount', async () => {
        const httpMock: HttpTestingController = TestBed.inject(HttpTestingController);
        const responseBody: any = 0;
        const responseHeaders: any = { headers: { 'Content-Type': 'application/json' } };

        new ODataQuery(odataService, SERVICE_ROOT).entitySet(ENTITY_SET).countSegment().get().subscribe((odataResponse: ODataResponse) => {
